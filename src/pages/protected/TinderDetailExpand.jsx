...
const TinderDetailExpand = ({ showAbout, setShowAbout, toggleAbout }) => {
            ...
            <div className="relative h-screen w-full overflow-y-auto bg-white  pb-20">
                ...
                <div className="px-2">
                    ...
                    <div className="my-4 p-4 bg-slate-50 rounded-md">
                        ...
                        <p className="ml-6 text-gray-800">My name is John, I am Stright man.I am looking for women,
                            i am 34 year old single no children, i live in libya.
                            I work is a banker and i am looking for long term relation.</p>
                ...
                <div className="fixed  bottom-4  left-1/2 z-30 transform -translate-x-1/2 flex items-center space-x-2 md:space-x-4 overflow-x-hidden">
                    ...
                    {/* Dislike Button */}
                    <button onClick={() => setShowAbout(false)} className="bg-white p-5 rounded-full shadow-lg">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    {/* Super Like Button */}
                    <button onClick={() => setShowAbout(false)} className="bg-white p-4 rounded-full shadow-lg">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
...
export default TinderDetailExpand
