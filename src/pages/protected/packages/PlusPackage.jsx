      ...
      <div className="max-w-md md:max-w-6xl mx-auto relative ">
        ...
        <div className="flex items-center justify-between  p-6">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-1 px-2 py-0.5 bg-red-500 text-white text-xs font-bold rounded">PLUS</span>
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-8 p-6">
          Unlimited Likes. Unlimited Rewinds. Unlimited Passport Mode. No Ads.
        </h1>
          ...
          >
            {plans.map((plan) => (
              <SwiperSlide key={plan.id}>
                <div
                  className={`border-2 rounded-lg p-4 cursor-pointer h-44 relative ${selectedPlan === plan.id ? "border-red-500" : "border-red-300"}`}
        ...
        <div className="mb-40 p-6">
          <div className="text-center text-sm text-gray-600 mb-4">Included with Tinder Plus™</div>
