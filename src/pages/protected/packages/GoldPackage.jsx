...
const GoldPackage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-amber-50 min-h-screen ">
      <div className="max-w-md mx-auto relative ">
          ...
          >
            {plans.map((plan) => (
              <SwiperSlide key={plan.id}>
                <div
                  className={`border-2 rounded-lg p-4 cursor-pointer h-44 relative ${selectedPlan === plan.id ? "border-amber-500" : "border-amber-300"}`}
        ...
        <div className="mb-40 p-6">
          <div className="text-center text-sm text-gray-600 mb-4">Included with Tinder Gold™</div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-gray-800 font-semibold">2 Free Super Likes per week</p>
              </div>
            </li>
