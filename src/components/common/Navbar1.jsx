    ...
    <>
      ...
      <nav className="bg-white w-full px-4 md:px-8 py-4 flex justify-between items-center shadow-sm ">
        <div className="flex items-center">
          ...
          <div className="ml-6 hidden md:flex   space-x-4 text-gray-600 ">
            ...
            >
              ...
              {isDropdownOpen && (
                <div className="absolute top-3 -left-2 pt-2 space-y-1 bg-white shadow-lg mt-2 w-40 text-sm  p-4 rounded-lg py-2">
                  ...
                  <Link to="/select" className="block font-bold  text-gray-600 hover:text-red-600 hover:underline ">
                    Tinder SELECT
                  </Link>
            ...
            >
              ...
              <Link to="/safety-tips" className="text-gray-600 hover:text-red-600 hover:underline">
                Safety
              </Link>
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <button className=" text-white px-6 py-1 rounded-full  font-medium " onClick={() => setShowPopup(true)}
        ...
        <button className="md:hidden text-gray-" onClick={openMenu} aria-label="Open menu">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
